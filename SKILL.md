...
description: Use when a user wants to design a personal WeChat public account article template, choose visual directions, adapt DESIGN.md inspiration, or create reusable WeChat article style systems.
---
...
Help users design their own reusable WeChat public account article template. This skill is for visual system design, not article writing, article publishing, or one-off Markdown conversion.
...
- Do not generate a full article publishing workflow unless the user explicitly asks; this skill stops at template design.
